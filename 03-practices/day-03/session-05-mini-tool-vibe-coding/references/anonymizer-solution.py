...
def main() -> None:
    ...
    # 1. Chạy với tệp mẫu 01 (PII rõ ràng)
    input_path_1 = base_dir / "synthetic-data" / "pii-sample-01.txt"
    output_path_1 = base_dir / "outputs" / "sample-output-01.txt"
    log_path = base_dir / "outputs" / "execution-log.csv"
    
    process_file(input_path_1, output_path_1, log_path)

    # 2. Chạy với tệp mẫu 02 (PII phức tạp / Tricky)
    input_path_2 = base_dir / "synthetic-data" / "pii-sample-02-tricky.txt"
    output_path_2 = base_dir / "outputs" / "sample-output-02-tricky.txt"
